...
local registerCloudTexture = include("src/procedural_textures/CloudTexture.lua")
local registerFireTexture = include("src/procedural_textures/FireTexture.lua")
local registerGrassTexture = include("src/procedural_textures/GrassTexture.lua")
local registerMarbleTexture = include("src/procedural_textures/MarbleTexture.lua")
local registerStoneTexture = include("src/procedural_textures/StoneTexture.lua")
local registerWaterTexture = include("src/procedural_textures/WaterTexture.lua")
local registerWoodTexture = include("src/procedural_textures/WoodTexture.lua")

local ProceduralTextureRenderer = Class:new({
    _type = "ProceduralTextureRenderer",
    camera = nil,
    noise = nil,
...
registerCloudTexture(ProceduralTextureRenderer)
registerFireTexture(ProceduralTextureRenderer)
registerGrassTexture(ProceduralTextureRenderer)
registerMarbleTexture(ProceduralTextureRenderer)
registerStoneTexture(ProceduralTextureRenderer)
registerWaterTexture(ProceduralTextureRenderer)
registerWoodTexture(ProceduralTextureRenderer)

return ProceduralTextureRenderer
