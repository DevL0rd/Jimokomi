...
typedef struct SpatialGridStatsSnapshot {
    ...
    double rebuild_ms;
    double incremental_update_ms;
    double query_ms;
    uint32_t query_cells;
    uint32_t query_hits;
    uint32_t query_false_positives;
    uint32_t rebuild_non_empty_cells;
    uint32_t rebuild_max_cell_entries;
    double rebuild_hottest_cell_ms;
    uint32_t query_max_cell_visits;
    double query_hottest_cell_ms;
    uint32_t dirty_cell_count;
    uint32_t incremental_dirty_entity_count;
